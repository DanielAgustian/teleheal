                      ...
                      FocusScope(
                        child: InputWidget1(
                          ...
                          callbackValidation: (val) {
                            ...
                            if (val.length > 10) {
                              return "Nomor handphone tidak boleh di atas 10 angka.";
                            }
                            return null;
                          },
                          isEditable: true,
                      ...
                      FocusScope(
                        child: InputWidget1(
                          ...
                          callbackValidation: (val) {
                            ...
                            if (val.length < 6) {
                              return "Konfirmasi Password terdiri dari minimum 6 karakter!";
                            }
